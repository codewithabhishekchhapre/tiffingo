                            ...
                            <div className="flex items-center justify-between px-1 relative">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        showFilters ? "bg-red-600 text-white" : "text-slate-400 hover:text-primary hover:bg-slate-50"
                                    )}
                                >
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            selectedSeller?.id === s.id
                                                ? "bg-red-600 text-white shadow-xl translate-x-1"
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center gap-3 px-1">
                                            ...
                                            <button
                                                ...
                                                className="flex-1 py-1.5 bg-red-600 text-white rounded-xl text-[10px] font-bold shadow-lg hover:shadow-primary/20 transition-all active:scale-[0.98]"
                                            >
                                                VIEW NODE INTEL
                                            </button>
                                        </div>
                            ...
                            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                                ...
                                >
                                    <div className="text-center space-y-4">
                                        ...
                                        <div className="p-6 bg-red-600 rounded-xl text-left space-y-4">
