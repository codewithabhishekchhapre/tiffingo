      ...
      <header className="sticky top-0 z-50 bg-[#ffffffcc] border-b border-[#EDE8E0] shadow-xs">
        <div className="flex items-center justify-between px-4 md:px-6 py-3">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <button
              onClick={onMenuClick}
              className="lg:hidden p-2 -ml-2 rounded-md text-[#5C5247] hover:bg-[#FFF3EB] hover:text-primary transition-colors"
          ...
          <div className="flex-1 flex justify-end md:justify-center max-w-md mx-2 md:mx-8">
            <button
              ...
              className="flex items-center justify-center md:justify-start gap-2 w-11 h-11 md:w-full md:h-auto md:px-4 md:py-2 rounded-full bg-white text-[#9E8F7E] cursor-pointer hover:bg-[#FFF3EB]/85 hover:text-primary hover:border-primary/50 transition-colors border border-[#EDE8E0]"
              aria-label="Search"
            >
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <Popover open={notificationsOpen} onOpenChange={setNotificationsOpen}>
              <PopoverTrigger asChild>
                <button
                  type="button"
                  className="relative h-11 w-11 rounded-full border border-[#EDE8E0] bg-white text-[#1A1A1A] flex items-center justify-center hover:bg-[#FFF3EB] hover:text-primary transition-colors"
                  aria-label="Notifications"
                >
                  <Bell className="w-5 h-5 text-[#5C5247] hover:text-primary" />
                  {notificationCount > 0 && (
                    <span className="absolute top-2 right-2 min-w-4 h-4 rounded-full bg-primary text-white text-[10px] font-bold flex items-center justify-center px-1">
            ...
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuGroup>
                  <DropdownMenuItem
                    className="cursor-pointer hover:bg-[#FFF3EB] hover:text-primary focus:bg-[#FFF3EB] focus:text-primary"
                    onClick={() => navigate(
