                ...
                <div className="relative text-center">
                  ...
                  <div className="flex flex-col gap-3">
                    <button
                      ...
                      className="w-full py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-2xl shadow-lg shadow-orange-500/25 transition-all duration-300 transform active:scale-95 flex items-center justify-center gap-2"
                    >
