                  ...
                  <div className="flex-1 flex flex-col justify-between min-h-[80px]">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[11px] font-medium border border-primary/40 text-primary">
              ...
              <div className="flex gap-3">
                {String(booking.status || "").toLowerCase() === "pending" && (
                  <button
                    ...
                    className="flex-1 bg-primary text-white py-3 rounded-2xl text-[13px] font-bold hover:bg-[#E64D02] transition-all active:scale-[0.98] shadow-sm shadow-primary/10 uppercase tracking-wide">
                    Accept
                  </button>
                )}
                {String(booking.status || "").toLowerCase() === "pending" && (
          ...
          <>
            <motion.div
              ...
              <motion.div
                ...
                {/* Header Ribbon */}
                <div className="bg-primary px-5 py-4 flex justify-between items-center text-white border-b border-red-600/20">
                  <div>
                ...
                <div className="p-4 border-t border-gray-100 bg-white">
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      disabled={isAcceptingOrder}
                      className="w-full py-3 bg-white border border-primary/20 text-primary rounded-xl font-bold text-sm hover:bg-red-50 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                      Reject Order
                    </button>
                  </div>
                </div>
                      ...
                      {selectedOrder.deliveryPartnerId.phone === "Hidden until photo upload" || !selectedOrder.deliveryPartnerId.phone ? (
                        ...
                        <div className="flex items-center justify-between bg-green-50/50 border border-green-200/50 rounded-xl p-2">
                          ...
                          <a
                            ...
                            className="inline-flex items-center justify-center gap-1 px-2.5 py-1.5 bg-primary text-white text-[10px] font-bold rounded-lg shadow-sm hover:bg-[#e04a02] transition-colors shrink-0"
                          >
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          {isPreparing && onMarkReady && (
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-xs font-bold text-white bg-primary hover:bg-red-600 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed transition-all shadow-sm">
