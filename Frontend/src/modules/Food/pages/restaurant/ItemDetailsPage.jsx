        ...
        <div className="relative bg-white lg:rounded-2xl lg:border lg:border-gray-200 lg:overflow-hidden lg:shadow-sm">
          ...
          <div className="px-4 py-4 bg-white border-t border-gray-100">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 px-6 py-3.5 bg-primary hover:bg-[#E64D02] text-white rounded-xl text-sm font-semibold cursor-pointer transition-all shadow-md hover:shadow-lg active:scale-95"
            >
        ...
        <div className="p-4 lg:p-0 space-y-3">
          ...
          <div>
            ...
            <NameSuggestionField
              ...
              inputClassName="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="MRP"
                          className="w-full pl-8 pr-3 py-3 border border-gray-300 rounded-lg text-sm text-gray-900 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                        />
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-gray-600">{"\u20B9"}</span>
                      </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                          ...
                          <div>
                            ...
                            <select
                              ...
                              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent appearance-none"
                            >
        ...
        <div className={`max-w-5xl mx-auto w-full flex gap-3 px-4 lg:px-6 py-4 ${isNewItem ? 'justify-end' : ''}`}>
          ...
          <button
            ...
            className={`${isNewItem ? 'w-full sm:w-56' : 'flex-1 sm:flex-none sm:w-56'} py-3 px-4 rounded-lg text-sm font-semibold transition-colors flex items-center justify-center gap-2 ${!uploadingImages && !isItemNameDuplicate
              ? "bg-primary text-white hover:bg-[#E64D02]"
