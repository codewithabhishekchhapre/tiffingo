...
export default function ExploreMore() {
  ...
  const accountingItems = [
    ...
    { id: 4, label: "COD Deposit Verification", icon: FileCheck, route: "/restaurant/finance/cod-verification" },
  ]
          ...
          return (
            ...
            >
              <motion.button
                ...
                className="w-full flex items-center justify-center p-5 bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-primary/30 transition-colors duration-200 min-h-[90px]"
              >
              ...
              <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    autoFocus
                    className="w-full px-4 py-2 pr-10 bg-gray-100 dark:bg-gray-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                  />
                  {searchQuery && (
                    <button
