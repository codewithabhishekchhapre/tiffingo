...
export default function RestaurantWelcome() {
  ...
  const companyName = useCompanyName() || "Tiffingo"
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-black overflow-hidden">
      ...
      >
        ...
        <Button
          onClick={handleLogin}
          className="w-full bg-primary hover:bg-[#E64D02] text-white font-bold py-6 md:py-7 text-base md:text-lg rounded-lg transition-colors shadow-lg"
        >
          Login
        </Button>
