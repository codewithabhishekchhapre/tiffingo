        ...
        <div ref={tabBarRef} className="grid grid-cols-2 gap-3">
          <motion.button
            ...
            className={`relative overflow-hidden rounded-[24px] border px-4 py-3 text-sm font-semibold whitespace-nowrap ${activeTab === "all-items"
              ? "border-primary text-white shadow-[0_18px_32px_-24px_rgba(73,171,20,0.8)]"
          ...
          >
            ...
            <span className="relative z-10 flex items-center justify-center gap-2">
              <span>All items</span>
              <span className={`rounded-full px-2 py-0.5 text-xs font-semibold ${activeTab === "all-items" ? "bg-white text-primary" : "bg-slate-100 text-slate-600"
                }`}>
                {totalItems}
              </span>
            </span>
                ...
                return (
                  <button
                    ...
                    className={`shrink-0 rounded-full border px-3 py-1.5 text-xs font-semibold transition-colors ${isActive
                      ? "border-primary bg-primary text-white shadow-[0_14px_28px_-24px_rgba(255, 106, 0,0.5)]"
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-primary text-white rounded-md text-sm font-medium hover:bg-[#E64D02] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                      >
            ...
            >
              ...
              <div className="p-6 border-t border-gray-100 flex flex-col-reverse sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 px-4 rounded-xl font-semibold bg-primary text-white hover:bg-[#e65f00] shadow-sm transition-colors text-sm sm:w-1/2"
                >
                  Apply Filters
                </button>
              </div>
                  ...
                  <label className="flex items-center justify-between py-4 cursor-pointer">
                    <div className="flex flex-col gap-1 flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Item won't be visible to customers on Tiffingo app till you mark it back in stock
                      </p>
                    </div>
                  </label>
                </div>
      ...
      <div className="fixed right-4 bottom-24 z-30 flex flex-col items-end gap-2">
        {activeTab === "add-ons" ? (
          <motion.button
            ...
            className="rounded-full bg-primary px-5 py-3 text-sm font-semibold text-white shadow-[0_22px_40px_-24px_rgba(73,171,20,0.6)]"
          >
            + Add add-on
          </motion.button>
        ) : (
