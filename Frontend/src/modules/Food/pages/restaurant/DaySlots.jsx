    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
          ...
          {dayData.slots.map((slot, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white dark:bg-[#111] p-4 space-y-3 mb-0 border-b border-gray-100 dark:border-gray-800"
              >
                {/* Slot Header */}
        ...
        {dayData.slots.length < 3 && (
          <button
            onClick={addSlot}
            className="w-full text-primary hover:text-[#e05e00] text-sm font-medium py-3 transition-colors"
          >
            + Add time slot
          </button>
        )}
      ...
      <div className="sticky bottom-0 bg-white dark:bg-[#111] border-t border-gray-100 dark:border-gray-800 px-4 py-4 z-40">
        <div className="space-y-4">
          ...
          <Button
            onClick={handleSave}
            className="w-full bg-primary hover:bg-[#e05e00] text-white font-semibold py-3 rounded-xl"
          >
            Save
          </Button>
        </div>
