  ...
  return (
    ...
    >
        ...
        <div>
          ...
          {/* Customer Card */}
          <div className="bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800 p-4 gap-8 flex flex-col mb-3">
        ...
        {orderData.deliveryPartner && (
          <div>
            ...
            <div className="bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800 p-4 flex flex-col gap-4 mb-3">
              <div className="flex items-center gap-3">
                ...
                {orderData.deliveryPartner.phone === "Hidden until photo upload" || !orderData.deliveryPartner.phone ? (
                  ...
                  <div className="flex items-center justify-between bg-green-50/50 border border-green-200/60 rounded-xl p-3">
                    ...
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-primary text-white text-xs font-bold rounded-lg shadow-sm hover:bg-[#e04a02] transition-colors"
                    >
        ...
        <div>
          ...
          {orderData.items.map((item, index) => (
            <div key={index} className="bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800 p-4">
