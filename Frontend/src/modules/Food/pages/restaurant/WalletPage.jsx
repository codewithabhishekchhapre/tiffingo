  ...
  return (
    <div className="min-h-screen bg-[#f6e9dc] overflow-x-hidden">
      ...
      <Modal
        ...
        footer={
          <Button
            ...
            className="w-full h-14 bg-primary hover:bg-[#e05e00] text-white rounded-2xl font-black text-lg shadow-xl disabled:opacity-50"
      ...
      >
        ...
        {isLowBalance && (
          <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/15 border-2 border-red-200 dark:border-red-800/40 rounded-2xl">
            <div className="flex items-center gap-2 mb-2">
              <AlertCircle className="w-5 h-5 text-red-600 dark:text-red-400" />
              <span className="text-sm font-bold text-red-800 dark:text-red-300">Low Balance</span>
            </div>
            <p className="text-xs text-red-600 dark:text-red-400 mb-2">
              Minimum ₹1000 required to stay active
            </p>
            <div className="flex justify-between text-xs">
              <span className="text-red-500 dark:text-red-400">Current: {formatCurrency(currentBalance)}</span>
              <span className="text-red-800 dark:text-red-300 font-bold">Required: {formatCurrency(requiredRecharge)}</span>
            </div>
          </div>
        )}

        <div className="mb-6">
          <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Recharge Amount</label>
          <div className="relative">
            ...
            <Input
              ...
              className="pl-8 h-14 text-xl font-black border-2 border-gray-100 dark:border-gray-700 focus:border-primary rounded-2xl"
        ...
        <div className="grid grid-cols-3 gap-2">
          {quickAmounts.map(amt => (
            <button
              ...
              className="py-3 rounded-xl text-sm font-bold border-2 border-gray-100 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-primary hover:text-primary transition-all"
            >
              ₹{amt}
            </button>
          ))}
