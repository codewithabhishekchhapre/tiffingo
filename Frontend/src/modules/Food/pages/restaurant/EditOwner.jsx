      ...
      <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] overflow-x-hidden">
        ...
        <div className="bg-white dark:bg-[#111] border-b border-gray-100 dark:border-gray-800 px-4 py-4 sticky top-0 z-50">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-base font-bold text-gray-900 dark:text-white">Contact details</h1>
          </div>
        </div>
        ...
        <div className="px-4 py-6 space-y-6">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <button
              ...
              className="text-primary text-sm font-medium hover:text-[#e05e00] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Edit photo
            </button>
            <input
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  disabled={loading || saving}
                />
                <Edit className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-primary" />
              </div>
            </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#111] border-t border-gray-100 dark:border-gray-800 px-4 py-4 z-40">
          <Button
            onClick={handleSave}
