          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div className="flex gap-2 no-print">
              ...
              <Button
                ...
                className="bg-primary hover:bg-primary flex items-center gap-2 text-xs sm:text-sm h-9 sm:h-10"
              >
          ...
          <Card ref={invoiceRef} className="dark:bg-[#1a1a1a] dark:border-gray-800">
            <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10">
              ...
              <div className="total-section mt-4 sm:mt-6">
                ...
                <div className="grand-total flex justify-between text-base sm:text-lg md:text-xl md:text-2xl pt-2 sm:pt-3 mt-2 sm:mt-3 border-t-2 border-primary">
                  <span>Total:</span>
