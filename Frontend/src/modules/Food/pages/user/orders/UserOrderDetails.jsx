    ...
    <div className="min-h-screen bg-gray-50 pb-24 font-sans relative">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {source.phone ? (
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-primary hover:bg-red-50 shrink-0"
                      >
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-4 flex justify-between items-center border-b border-gray-100">
            ...
            <button
              ...
              className="w-7 h-7 rounded-full bg-red-50 flex items-center justify-center text-primary hover:bg-red-100"
            >
      ...
      <div className="fixed bottom-0 w-full bg-white border-t border-gray-200 p-4 flex gap-3 z-20">
        <button
          ...
          className="flex-1 bg-primary text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-primary transition-colors"
        >
        ...
        <button
          type="button"
          onClick={handleDownloadSummary}
          className="flex-1 bg-white border border-primary text-primary py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-red-50 transition-colors"
        >
          <Download className="w-4 h-4" />
          Invoice
        </button>
