...
export default function ShippingPolicyV2() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] overflow-x-hidden">
      <div className="fixed top-0 left-0 right-0 z-20 bg-white border-b border-gray-200 px-4 py-4 flex items-center gap-4 shadow-sm">
        ...
        <h1 className="text-lg font-bold text-gray-900">Shipping Policy</h1>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20">
              <Loader2 className="w-8 h-8 text-[#FF6A00] animate-spin mb-4" />
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
              {content ? (
                ...
                <p className="text-gray-500">No shipping policy content available.</p>
              )}
              {lastUpdated && (
