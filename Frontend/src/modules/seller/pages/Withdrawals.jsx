            ...
            <BlurFade delay={0.1}>
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-red-500 text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-red-600 transition-all shadow-xl active:scale-95 flex items-center gap-2 group"
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                {[
                    ...
                    <BlurFade key={i} delay={0.2 + i * 0.1}>
                        <Card className="p-6 border-none shadow-sm ring-1 ring-slate-100 hover:ring-red-200 transition-all bg-white group relative overflow-hidden">
                ...
                <Card className="border-none shadow-xl ring-1 ring-slate-100 overflow-hidden bg-white rounded-3xl">
                    <div className="p-4 sm:p-6 border-b border-slate-50 flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
                        ...
                        <div className="relative w-full md:w-64 group">
                            <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-600 group-focus-within:text-red-500 transition-colors" />
                            <input
                                type="text"
                                placeholder="Search ID or Status..."
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border-none rounded-xl text-xs font-semibold outline-none focus:ring-2 focus:ring-red-500/10 transition-all"
                            />
                        </div>
                    </div>
                                    ...
                                    <tr key={item.id || item.ref || item.reference || `wd-${idx}`} className="group hover:bg-slate-50/50 transition-all">
                                        ...
                                        <td className="px-8 py-5 text-right">
                                            ...
                                            <button
                                                ...
                                                className="text-[10px] font-black text-red-500 hover:text-red-600 mt-1 uppercase tracking-widest flex items-center gap-1 justify-end ml-auto"
                                            >
                ...
                <form onSubmit={handleSubmitRequest} className="space-y-6 py-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <div className="relative group">
                                <span className="absolute left-5 top-1/2 -translate-y-1/2 text-2xl font-black text-slate-300 group-focus-within:text-red-500 transition-colors">₹</span>
                                <input
                                    type="number"
                                    value={amount}
                                    onChange={(e) => setAmount(e.target.value)}
                                    placeholder="0.00"
                                    className="w-full pl-12 pr-6 py-4 bg-white ring-1 ring-slate-200 focus:ring-2 focus:ring-red-500/20 focus:border-red-500 rounded-2xl text-xl font-black outline-none transition-all placeholder:text-slate-200"
                                />
                            </div>
                        </div>

                        <div className="p-4 bg-red-50/50 rounded-2xl border border-red-100/50 space-y-3">
                            <p className="text-[10px] font-black text-red-600 uppercase tracking-widest mb-1">Transfer Destination</p>
                    ...
                    <div className="flex flex-col gap-3 pt-4">
                        <button
                            ...
                            className="w-full py-4 bg-red-500 text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl flex items-center justify-center gap-2 hover:bg-red-600 disabled:opacity-50 transition-all active:scale-95"
                        >
