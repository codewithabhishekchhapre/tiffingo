              ...
              {(statsData?.topProducts || []).map((product, i) => (
                <div
                  ...
                  <div className="flex items-center gap-4">
                    <div className="h-10 w-10 bg-slate-100 rounded-lg flex items-center justify-center text-slate-600 font-black text-xs group-hover:bg-red-500 group-hover:text-white transition-all">
                      {i + 1}
                    </div>
                    <div>
          ...
          <Card className="border-none shadow-xl shadow-slate-200/50 rounded-3xl p-6 bg-white overflow-hidden group h-full">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 border-t border-slate-50 pt-8">
              <div className="text-center">
                <div className="h-10 w-10 bg-red-50 text-red-600 rounded-xl flex items-center justify-center mx-auto mb-2">
