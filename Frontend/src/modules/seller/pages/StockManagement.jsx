...
const StockManagement = () => {
    ...
    const stats = useMemo(() => [
        { label: 'Total Inventory', value: inventory.reduce((acc, item) => acc + item.stock, 0), icon: HiOutlineCube, color: 'text-red-600', bg: 'bg-red-50', status: 'All' },
                            ...
                            <div className="p-4 border-b border-slate-50 flex flex-col gap-3 bg-slate-50/30">
                                <div className="relative w-full">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 pr-4 py-2.5 rounded-2xl border-none ring-1 ring-slate-200 bg-white focus:ring-2 focus:ring-red-500/20 transition-all text-xs font-semibold"
                                        value={searchTerm}
                                ...
                                <table className="w-full text-left">
                                    <thead>
                                        <tr className="bg-slate-50/50 border-b border-slate-100">
                                            {isPharmacySeller ? (
                                                <>
                                                    <th className="px-6 py-4 text-xs font-black text-slate-600 uppercase tracking-widest">Product Name</th>
                                                    <th className="px-6 py-4 text-xs font-black text-slate-600 uppercase tracking-widest">Batch Number</th>
                                                    <th className="px-6 py-4 text-xs font-black text-slate-600 uppercase tracking-widest">Strength</th>
                                                    <th className="px-6 py-4 text-xs font-black text-slate-600 uppercase tracking-widest">Pack Type</th>
                                                    <th className="px-6 py-4 text-xs font-black text-slate-600 uppercase tracking-widest">Current Stock</th>
                                                    <th className="px-6 py-4 text-xs font-black text-slate-600 uppercase tracking-widest">Expiry Date</th>
                                                    <th className="px-6 py-4 text-xs font-black text-slate-600 uppercase tracking-widest">Days Remaining</th>
                                                    <th className="px-6 py-4 text-xs font-black text-slate-600 uppercase tracking-widest">Low Stock Status</th>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-4 py-4 bg-slate-50 border-none rounded-2xl text-2xl font-black text-slate-900 focus:ring-2 focus:ring-red-500/20 transition-all outline-none"
                                                placeholder="0"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full px-4 py-3 bg-slate-50 border-none rounded-2xl text-xs font-semibold text-slate-700 focus:ring-2 focus:ring-red-500/20 transition-all outline-none resize-none h-20"
