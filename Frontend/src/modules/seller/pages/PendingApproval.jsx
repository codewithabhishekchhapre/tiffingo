  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#0f172a_0%,#111827_30%,#f8fafc_30%,#f8fafc_100%)] px-4 py-10 font-['Outfit'] md:px-8 seller-theme-scope">
      <div className="mx-auto max-w-5xl">
        ...
        >
          <div className="bg-[radial-gradient(circle_at_top_left,_rgba(239,68,68,0.35),_transparent_28%),linear-gradient(135deg,#0f172a_0%,#7f1d1d_100%)] px-8 py-10 text-white">
          ...
          <div className="grid gap-6 p-8 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                tone: isRejected ? "bg-rose-50 text-rose-700" : "bg-red-50 text-red-700",
              },
            ].map((item) => (
          ...
          <div className="mx-8 mb-8 rounded-[28px] border border-slate-100 bg-slate-50 p-6">
            <div className="flex items-start gap-4">
              <div className={`rounded-2xl p-3 ${isRejected ? "bg-rose-100 text-rose-600" : "bg-red-100 text-red-600"}`}>
          ...
          <div className="flex flex-col gap-3 border-t border-slate-100 px-8 py-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col gap-3 md:flex-row">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-red-500 px-5 py-3 text-sm font-black uppercase tracking-[0.18em] text-white transition hover:bg-red-600 disabled:opacity-70 shadow-xl hover:shadow-orange-500/30"
              >
