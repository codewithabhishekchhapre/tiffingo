        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-black text-slate-900 flex items-center gap-2 flex-wrap">
              ...
              <Badge
                variant="primary"
                className="text-[10px] sm:text-xs px-1.5 py-0 font-bold tracking-wider uppercase bg-red-100 text-red-700">
                Audit Trail
              </Badge>
            </h1>
          ...
          <div className="p-4 sm:p-6 border-b border-slate-50 flex flex-col gap-3 bg-white">
            ...
            <div className="relative w-full">
              ...
              <Input
                ...
                className="pl-10 pr-4 py-2.5 rounded-lg border-none ring-1 ring-slate-100 bg-slate-50/50 focus:ring-2 focus:ring-red-500/20 transition-all text-xs font-semibold"
                value={searchTerm}
                    ...
                    <motion.tr
                      ...
                      <td className="px-6 py-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="text-sm font-black text-slate-900 group-hover:text-red-500 transition-colors">
                              {txn.id ?? txn.ref ?? "—"}
                            </p>
