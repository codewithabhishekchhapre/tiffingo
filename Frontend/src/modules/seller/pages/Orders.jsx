        ...
        <div className="flex flex-col items-end gap-2 shrink-0">
          ...
          {canResendDispatch(order) && (
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg bg-red-50 text-red-700 text-[10px] font-black uppercase tracking-wider">
              Resend Rider
            </button>
          )}
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 sm:gap-4">
          <div className="min-w-0">
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 flex flex-wrap items-center gap-2">
              ...
              <Badge
                variant="primary"
                className="text-[10px] px-1.5 py-0 font-bold tracking-wider uppercase bg-red-100 text-red-700">
                Real-time
              </Badge>
            </h1>
          ...
          <div className="flex gap-2 flex-shrink-0">
            ...
            <Button
              ...
              className="bg-red-500 px-4 py-2 sm:px-6 sm:py-2.5 rounded-lg text-xs sm:text-sm font-bold text-white shadow-xl flex items-center space-x-1.5 sm:space-x-2">
                ...
                <motion.div
                  ...
                  <div className="p-4 sm:p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="h-9 w-9 sm:h-10 sm:w-10 bg-red-500 text-white rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/20 shrink-0">
