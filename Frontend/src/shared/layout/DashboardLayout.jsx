                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <div className="grid grid-cols-2 gap-4 w-full">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-2 py-4 rounded-2xl bg-red-500 text-white font-bold hover:bg-red-500/90 shadow-xl shadow-orange-500/20 transition-all active:scale-95"
                                    >
